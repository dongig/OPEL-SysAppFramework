var addon = require('/home/pi/techfair/node/OPELRecording');
var sensorManager = require('/home/pi/techfair/node/sensfw/nil');
var sysAppNIL = require('/home/pi/techfair/node/sysfw/nil');
...
var repeat = setInterval(function(){
		...
		console.log('Capture!');
			dt = new Date(); 
			d = cnt++;
			var fileName = '/home/pi/opelData/quickCam'+d+'.jpeg';
			recObj.start(fileName, 1, function(err, data){
				if(data){
				console.log("/home/pi/opelData/quickCam.jpeg Saved\n");
				//Notify
